...
- If motionThemeId or motionTheme is provided, generate a motion config file (e.g., engine/motion.config.js) exporting ease/duration/stagger/hover/tap defaults, and use those in components.
...
function ensureThemeFiles(blueprint, files) {
  ...
  const motionPath = "engine/motion.config.js";
